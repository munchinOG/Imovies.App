#pragma checksum "C:\Users\user\Desktop\IMov\OMDBMvc-master\Imovie.App\Areas\Admin\Views\Shared\_AdminLayout.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "31c6be925aa0509680ee6f424b120e48a6d827cf"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"31c6be925aa0509680ee6f424b120e48a6d827cf", @"/Areas/Admin/Views/Shared/_AdminLayout.cshtml")]
...
#line 1 "C:\Users\user\Desktop\IMov\OMDBMvc-master\Imovie.App\Areas\Admin\Views\Shared\_AdminLayout.cshtml"
Write(RenderBody());

#line default
#line hidden
            EndContext();
            BeginContext(13, 39867, true);
  ...
  ");
            WriteLiteral(@"                  <div class=""top-report"">
                ...
                <!-- Top Report Start -->
                <div class=""col-x");
            WriteLiteral(@"lg-3 col-md-6 col-12 mb-30"">
                ...
                <!-- Top Report Start -->
   ");
            WriteLiteral(@"             <div class=""col-xlg-3 col-md-6 col-12 mb-30"">
                    <div class=""top-report"">
            ...
            WriteLiteral(@"                         </div>
                ...
                <div class=""col-md-4 mb-30"">
                    <div class=""box"">
                        ...
                        <div class=""box-body"">
                           ");
            WriteLiteral(@" <div class=""chartjs-market-trends-chart"">
                        ...
                        <div class=""box-body"">
                            <div class=""table-responsive"">
                                <table class=""table table-vertical-middle table-selectable"">
                                    ...
                                    <thead>
                                        <tr>
                                            <th class=""selector""><label class=""adomx-checkbox""><inp");
            WriteLiteral(@"ut type=""checkbox""> <i class=""icon""></i></label></th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class=""selector""><label clas");
            WriteLiteral(@"s=""adomx-checkbox""><input type=""checkbox""> <i class=""icon""></i></label></td>
                    ...
                    ");
            WriteLiteral(@"                        <td><img src=""assets/images/product/list-product-2.jpg"" alt="""" class=""table-product-image rounded-circle""></td>
                                            <td><a href=""#"">Microsoft surface pro 4</a></td>
                                            <td>#MSP40022</td>
                                            <td>05 - Products</td>
                                            <td>$60000000.00</td>
                                        ...
                                        <tr>
                                            <td class=""selector""><label class=""adomx-checkbox""><input type=""checkbox""> <i class=""icon""></i></label></td>
                                            <td><img src=""assets/images/product/list-product-3.jpg"" alt="""" class=""table-product-image r");
            WriteLiteral(@"ounded-circle""></td>
                                            <td><a href=""#"">Microsoft surface pro 4</a></td>
                                            <td>#MSP40022</td>
                                            <td>05 - Products</td>
                                            <td>$60000000.00</td>
                                ...
                                <table class=""table daily-sale-report"">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <p>Sed do eiusmod tempor incididunt ut l");
            WriteLiteral(@"abore.</p>
                                            </td>
...
");
            WriteLiteral(@"                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><");
            WriteLiteral(@"span class=""text-success d-flex justify-content-between fw-600"">$1750.00<span class=""tippy"" data-tippy-content=""Sed do eiusmod tempor <br/> incididunt ut labore.""><i class=""zmdi zmdi-info-outline""></i></span></span></td>
                                        </tr>
                                        <tr>
            ...
            WriteLiteral(@"inda Price</td>
                ...
                <div class=""col-xlg-4 col-lg-6 col-12 mb-30"">
                    <div class=""box"">
                        <div class=""box-head"">
                            <h4 ");
            WriteLiteral(@"class=""title"">To-do List</h4>
                        </div>
                        <div class=""box-body p-0"">
                            ...
                            <ul class=""todo-list"">
                                ...
                                <li class=""done"">
                                    ...
                                    <div");
            WriteLiteral(@" class=""list-action right"">
                                        <button class=""remove""><i class=""zmdi zmdi-delete""></i></button>
                                    </div>
                                </li>
                                <!--Todo Item End-->
             ...
             ");
            WriteLiteral(@"                       <div class=""list-action right"">
                                        <button class=""remove""><i class=""zmdi zmdi-delete""></i></button>
                                    </div>
                                </li>
                                <!--Todo Item End-->
            ...
            WriteLiteral(@">
                                ...
                                <li class=""done"">
                                    ...
                                    <div class=""list-content"">
                                        <p>");
            WriteLiteral(@"Sed ut perspiciatis unde omnis iste natus error.</p>
                                    </div>
                                    <div class=""list-action right"">
                                        <button class=""remove""><i class=""zmdi zmdi-delete""></i></button>
                                    </div>
                                ...
                                <li>
                                    ...
                                    <div class=""list-content"">
     ");
            WriteLiteral(@"                                   <p>Nor again is there anyone who loves.</p>
                                    </div>
                                    <div class=""list-action right"">
                                        <button class=""remove""><i class=""zmdi zmdi-delete""></i></button>
                                    </div>
            ...
            WriteLiteral(@"ass=""list-content"">
                            ...
                            <form action=""#"" class=""todo-list-add-new"" data-date=""false"">
                                ...
                                <button class=""submit""><i class=""zmdi zmdi-plus-circle-");
            WriteLiteral(@"o""></i></button>
                            </form>
                            <!--Add Todo List End-->
    ...
    ");
            WriteLiteral(@"                                            <a href=""#""><i class=""zmdi zmdi-replay""></i></a>
                                            </div>
                                            <div class=""body"">
                                    ...
                                    <li>
                                        <div class=""widget-chat"">
                                            <div class=""head"">
                                                <h5");
            WriteLiteral(@">Jennifer White</h5>
